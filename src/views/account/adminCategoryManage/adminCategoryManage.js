  ...
  category.forEach(async (element) => {
    ...
    subcategories.forEach((data) => {
      ...
      async function addDeleteCategoryEvent(){
        ...
        await Api.delete("/api","subcategory",{subCategoryName:data.subCategoryName})
        alert(data.subCategoryName+"을 삭제 했습니다.")
      }

      async function addModifyCategoryEvent(){
        // await Api.del("/api","subcategory",subCategoryName)
        console.log('클릭 '+data.subCategoryName);
      }
    });
  });
